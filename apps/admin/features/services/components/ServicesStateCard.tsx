...
export function ServicesStateCard({
  title,
  message,
  tone,
  actionLabel,
  ...
  const classNameByTone: Record<ServicesStateCardProps['tone'], string> = {
    error: 'border-[#FCA5A5]',
    neutral: 'border-[#E5E7EB]',
    warning: 'border-[#FBBF24]',
  };
  const titleClassNameByTone: Record<ServicesStateCardProps['tone'], string> = {
    error: 'text-[#B91C1C]',
    neutral: 'text-[#111827]',
    warning: 'text-[#92400E]',
  };
